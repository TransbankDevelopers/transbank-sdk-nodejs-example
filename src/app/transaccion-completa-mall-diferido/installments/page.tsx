...
import { ConfirmCard } from "@/app/transaccion-completa-mall/installments/components/ConfirmCard";
...
const actualBread: Route[] = [
  ...
  },
  {
    ...
    path: "/transaccion-completa-mall-diferido/installments",
  },
];
...
export default async function InstallmentsFullTransactionMallPage({
  ...
  return (
    <>
      ...
      <Layout
        pageTitle="Transacción Completa Mall Diferido - Consulta de cuotas"
        ...
        activeRoute="/transaccion-completa-mall-diferido/installments"
