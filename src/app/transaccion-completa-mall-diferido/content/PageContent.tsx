...
export const PageContent = (props: PageContentProps) => {
  ...
  const commitLink = () => {
    ...
    return {
      pathname: "/transaccion-completa-mall-diferido/create",
      query,
    };
  };

  const onPay = async () => {
    const creditCard: CreditCard & { isDeferred: boolean } = {
  ...
  return (
    <>
      ...
      <Layout
        pageTitle="Transacción Completa Mall Diferido - Formulario"
        ...
        activeRoute="/transaccion-completa-mall-diferido"
