...
export default function ApiRefTxMallDeferredCapture() {
    ...
    startTransition(async () => {
      try {
        const response = await fetch(
          "/api/transaccion-completa-mall-diferido/captureTransaction",
          {
            method: "POST",
            body: formData,
          }
    ...
    <Card className="card-pay">
      ...
      <form action={handleSubmit}>
        <div className="inp-container-card">
          ...
          />
          <InputText name="buyOrder" label="Orden de compra(Tienda hija)" />
