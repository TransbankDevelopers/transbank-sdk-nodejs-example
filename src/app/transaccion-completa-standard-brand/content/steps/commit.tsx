...
import * as commitSnippets from "@/app/transaccion-completa-standard-brand/content/snippets/commit";
...
export const getCommitSteps = (
  trxData: TBKMallCommitTransactionSBResponse,
): StepProps[] => {
  return [
    {
...

    {
      stepTitle: "¡Listo!",
      stepId: "listo",
      content: <OperationsCommitMessage />,
    },
  ];
};
