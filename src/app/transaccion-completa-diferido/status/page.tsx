...
import { getStatusTRXSteps } from "@/app/transaccion-completa-diferido/content/steps/status";
...
const actualBread: Route[] = [
  ...
  },
  {
    ...
    path: "/transaccion-completa-diferido/status",
  },
];
...
export default async function StatusWebpaytxfullPage({
  ...
  return (
    <>
      <Head>
        <title>Transacción Completa Diferido - Estado de transacción</title>
      </Head>
      <Layout
        pageTitle="Transacción Completa Diferido - Estado de transacción"
        ...
        activeRoute="/transaccion-completa-diferido/status"
