...
import { getCreateTRXSteps } from "@/app/transaccion-completa-diferido/content/steps/installments";
import Head from "next/head";
import { consultInstallmentsCompleteTransaction } from "@/app/lib/transaccion-completa-diferido/data";
import { NavigationItem } from "@/components/layout/Navigation";
import { NextPageProps } from "@/types/general";
import { InstallmentsCard } from "@/app/transaccion-completa-diferido/components/InstallmentsCard";
...
const actualBread: Route[] = [
  ...
  },
  {
    ...
    path: "/transaccion-completa-diferido/installments",
  },
];
...
export default async function InstallmentsWebpaytxfullPage({
  ...
  return (
    <>
      <Head>
        <title>Transacción Completa diferido - Consulta de cuotas</title>
      </Head>
      <Layout
        pageTitle="Transacción Completa diferido - Consulta de cuotas"
        ...
        activeRoute="/transaccion-completa-diferido/installments"
