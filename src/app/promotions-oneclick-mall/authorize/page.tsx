...
import { authorizeOneClickMallByDetails } from "@/app/lib/promotions-oneclick-mall/data";
...
const getActualBread = (): Route[] => {
  return [
    ...
    {
      name: "Autorizar pago",
      path: "/promotions-oneclick-mall/authorize",
    },
  ];
};
  ...
  return (
    <>
      ...
      <Layout
        ...
        activeRoute="/promotions-oneclick-mall/authorize"
